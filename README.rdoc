...
Rapidoc Koombea is refactor of rapidoc[https://github.com/drinor/rapidoc] gem.

== Installation

Add this line to your application's Gemfile:

    gem 'rapidoc', git: "https://your_oauth_github_token:x-oauth-basic@github.com/koombea/rapidoc.git"
